...
public final class OwoUIPipelines {
    ...
    /**
     * Stand-in for the {@code MATRICES_PROJECTION_SNIPPET} vanilla no longer exposes -
     * the globals + matrices/projection bind groups every gui pipeline needs
     */
    private static final RenderPipeline.Snippet MATRICES_PROJECTION_SNIPPET = RenderPipeline.builder(RenderPipelines.GLOBALS_SNIPPET)
